...
public class LoungeTVRoom extends LoungeRoom {
	...
	public void drawFixture(WorldGenerator generator, RealChunk chunk, Odds odds, int floor, int x,
		...
		case NORTH:
			...
			chunk.setBlocks(x, x + 3, y, y + height, z - 1, z, materialWall, (byte) 0);
		...
		case SOUTH:
			...
			chunk.setBlocks(x, x + 3, y, y + height, z + depth, z + depth + 1, materialWall, (byte) 0);
			break;
		case WEST:
			...
			chunk.setBlocks(x - 1, x, y, y + height, z, z + 3, materialWall, (byte) 0);
			break;
		case EAST:
			...
			chunk.setBlocks(x + width, x + width + 1, y, y + height, z, z + 3, materialWall, (byte) 0);
			break;
		}
	}
