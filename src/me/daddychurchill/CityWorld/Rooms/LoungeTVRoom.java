...
public class LoungeTVRoom extends LoungeRoom {
	...
	public void Draw(RealChunk chunk, Odds odds, int x, int y, int z,
		...
		case NORTH:
			...
			chunk.setBlocks(x, x + 3, y, y + height, z - 1, z, wallId, (byte) 0);
		...
		case SOUTH:
			...
			chunk.setBlocks(x, x + 3, y, y + height, z + depth, z + depth + 1, wallId, (byte) 0);
			break;
		case WEST:
			...
			chunk.setBlocks(x - 1, x, y, y + height, z, z + 3, wallId, (byte) 0);
			break;
		case EAST:
			...
			chunk.setBlocks(x + width, x + width + 1, y, y + height, z, z + 3, wallId, (byte) 0);
			break;
		}
	}
