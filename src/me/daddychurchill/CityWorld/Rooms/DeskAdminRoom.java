...
public class DeskAdminRoom extends DeskRoom {
	...
	public void drawFixture(CityWorldGenerator generator, RealBlocks chunk, Odds odds, int floor, int x,
		...
		default:
		case NORTH:
			chunk.setTable(x, x + 1, y, z, z + 2, Material.BIRCH_PRESSURE_PLATE);
			chunk.setBlock(x, y, z + 2, Material.BOOKSHELF);
			chunk.setBlock(x, y + 1, z + 2, Material.BIRCH_PRESSURE_PLATE);
			chunk.setBlock(x + 1, y, z + 1, Material.BIRCH_STAIRS, BlockFace.EAST);
			break;
		case SOUTH:
			chunk.setTable(x + 2, x + 3, y, z + 1, z + 3, Material.BIRCH_PRESSURE_PLATE);
			chunk.setBlock(x + 2, y, z, Material.BOOKSHELF);
			chunk.setBlock(x + 2, y + 1, z, Material.BIRCH_PRESSURE_PLATE);
			chunk.setBlock(x + 1, y, z + 1, Material.BIRCH_STAIRS, BlockFace.WEST);
			break;
		case WEST:
			chunk.setTable(x, x + 2, y, z + 2, z + 3, Material.BIRCH_PRESSURE_PLATE);
			chunk.setBlock(x + 2, y, z + 2, Material.BOOKSHELF);
			chunk.setBlock(x + 2, y + 1, z + 2, Material.BIRCH_PRESSURE_PLATE);
			chunk.setBlock(x + 1, y, z + 1, Material.BIRCH_STAIRS, BlockFace.NORTH);
			break;
		case EAST:
			chunk.setTable(x + 1, x + 3, y, z, z + 1, Material.BIRCH_PRESSURE_PLATE);
