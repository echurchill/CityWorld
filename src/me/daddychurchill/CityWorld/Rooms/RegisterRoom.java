...
public class RegisterRoom extends FilledRoom {
	...
	public void drawFixture(CityWorldGenerator generator, RealBlocks chunk,
		...
		case NORTH:
			...
			chunk.setBlocksTypeAndDirection(x + 2, x + 3, y, y + 1, z, z + 3, Material.PISTON, BlockFace.UP);
			break;
		case SOUTH:
			chunk.setBlocks(x, x + 1, y, y + 2, z, z + 3, materialWall);
			chunk.setBlocks(x, x + 1, y + 2, y + 3, z, z + 3, Material.GLASS_PANE);
		...
		case WEST:
			...
			chunk.setBlocksTypeAndDirection(x, x + 3, y, y + 1, z + 2, z + 3, Material.PISTON, BlockFace.UP);
			break;
		case EAST:
			chunk.setBlocks(x, x + 3, y, y + 2, z, z + 1, materialWall);
			chunk.setBlocks(x, x + 3, y + 2, y + 3, z, z + 1, Material.GLASS_PANE);
