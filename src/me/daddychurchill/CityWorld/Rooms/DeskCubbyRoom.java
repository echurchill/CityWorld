...
public class DeskCubbyRoom extends DeskRoom {
	...
	public void drawFixture(CityWorldGenerator generator, RealBlocks chunk, Odds odds, int floor, int x,
		...
		case NORTH:
			...
			chunk.setTable(x + 1, x + 2, y, z, z + 2, Material.BIRCH_PRESSURE_PLATE);
		...
		case SOUTH:
			...
			chunk.setTable(x + 1, x + 2, y, z + 1, z + 3, Material.BIRCH_PRESSURE_PLATE);
		...
		case WEST:
			...
			chunk.setTable(x, x + 2, y, z + 1, z + 2, Material.BIRCH_PRESSURE_PLATE);
		...
		case EAST:
			...
			chunk.setTable(x + 1, x + 3, y, z + 1, z + 2, Material.BIRCH_PRESSURE_PLATE);
