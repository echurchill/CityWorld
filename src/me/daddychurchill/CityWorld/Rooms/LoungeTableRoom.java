...
public class LoungeTableRoom extends LoungeRoom {
	...
	public void drawFixture(CityWorldGenerator generator, RealBlocks chunk, Odds odds, int floor, int x,
		...
		case SOUTH:
			...
			chunk.setTable(x + offset, x + 1 + offset, y, z, z + depth, Material.BIRCH_PRESSURE_PLATE);
			break;
		case WEST:
		case EAST:
			offset = odds.getRandomInt(depth);
			chunk.setTable(x, x + width, y, z + offset, z + 1 + offset, Material.BIRCH_PRESSURE_PLATE);
			break;
		}
	}
