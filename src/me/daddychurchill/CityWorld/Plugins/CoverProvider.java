...
public abstract class CoverProvider extends Provider {
	...
	public enum CoverageType {GRASS, FERN, DEAD_GRASS, CACTUS, REED, DANDELION, DEAD_BUSH, 
	...
	public enum FoliageSets {SHORT_FLOWERS, TALL_FLOWERS, ALL_FLOWERS,
		...
		EDIBLE_PLANTS, ALL_MUSHROOMS, NETHER_PLANTS, DECAY_PLANTS,
		ALL};
								
	public final static CoverageType[] ShortFlowers = {
	...
	public final static CoverageType[] TallFlowers = {
		CoverageType.SUNFLOWER, CoverageType.LILAC,
		CoverageType.ROSE_BUSH, CoverageType.PEONY};
	
	public final static CoverageType[] AllFlowers = {
		CoverageType.DANDELION, CoverageType.POPPY, 
		CoverageType.BLUE_ORCHID, CoverageType.ALLIUM, 
		CoverageType.AZURE_BLUET, CoverageType.OXEYE_DAISY,
		CoverageType.RED_TULIP, CoverageType.ORANGE_TULIP, 
...
//		CoverageType.MELON, CoverageType.PUMPKIN
	...
	public void setCoverage(SupportChunk chunk, int x, int y, int z, FoliageSets coverageSet) {
		switch (coverageSet) {
		case ALL:
			setCoverage(chunk, x, y, z, CoverageType.values());
			break;
		case ALL_FLOWERS:
			setCoverage(chunk, x, y, z, AllFlowers);
			break;
		case ALL_MUSHROOMS:
			setCoverage(chunk, x, y, z, AllMushrooms);
			break;
		case ALL_PLANTS:
	...
	public void setCoverage(SupportChunk chunk, int x, int y, int z, CoverageType coverageType) {
		switch (coverageType) {
		case GRASS:
			chunk.setBlockIfNot(x, y - 1, z, Material.GRASS);
		...
		case CACTUS:
			...
			break;
		case REED:
			chunk.setBlockIfNot(x, y - 1, z, Material.SAND, Material.GRASS, Material.DIRT);
			chunk.setBlocks(x, y, y + odds.getRandomInt(2) + 2, z, Material.SUGAR_CANE_BLOCK);
			break;
		case DANDELION:
			chunk.setBlockIfNot(x, y - 1, z, Material.GRASS, Material.SOIL, Material.DIRT);
		...
		case EMERALD_GREEN:
			chunk.setBlockIfNot(x, y - 1, z, Material.GRASS, Material.SOIL, Material.DIRT);
			chunk.setBlock(x, y, z, Material.LOG);
			chunk.setBlocks(x, y + 1, y + odds.getRandomInt(2, 2), z, Material.LEAVES);
			break;
		case OAK_SAPLING:
	...
	protected boolean likelyCover(WorldGenerator generator, Odds odds) {
