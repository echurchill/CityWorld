...
public class OreProvider_Normal extends OreProvider {
	...
	public OreProvider_Normal(CityWorldGenerator generator) {
		...
		ore_types.add(generator.settings.materials.itemsMaterialListFor_NormalOres.getNthMaterial(0, Material.WATER));
		ore_types.add(generator.settings.materials.itemsMaterialListFor_NormalOres.getNthMaterial(1, Material.LAVA));
		...
		ore_types.add(generator.settings.materials.itemsMaterialListFor_NormalOres.getNthMaterial(8, Material.DIAMOND_ORE));
		ore_types.add(generator.settings.materials.itemsMaterialListFor_NormalOres.getNthMaterial(9, Material.EMERALD_ORE)); 
	}
}
