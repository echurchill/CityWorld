...
public class MaterialProvider {
	...
	public MaterialList itemsRandomMaterials_BunkerChests = createList(tagRandomMaterials_BunkerChests,
			Material.IRON_PICKAXE, Material.IRON_SWORD, Material.IRON_SHOVEL,
			...
			Material.TORCH, Material.BUCKET, Material.WATER_BUCKET, Material.LAVA_BUCKET,
	...
	public MaterialList itemsRandomMaterials_MineChests = createList(tagRandomMaterials_MineChests,
			...
			Material.IRON_SWORD, Material.IRON_SHOVEL,

			Material.LEATHER_BOOTS, Material.LEATHER_CHESTPLATE, Material.LEATHER_HELMET, Material.LEATHER_LEGGINGS,

			Material.TORCH, Material.COMPASS, Material.CLOCK, Material.FLINT, Material.FLINT_AND_STEEL, Material.BUCKET,
			Material.WATER_BUCKET, Material.LAVA_BUCKET, Material.GUNPOWDER, Material.SAND,

			Material.BOOK, Material.COAL, Material.DIAMOND, Material.IRON_INGOT, Material.GOLD_INGOT,

			Material.APPLE, Material.ROTTEN_FLESH);
	...
	public MaterialList itemsRandomMaterials_SewerChests = createList(tagRandomMaterials_SewerChests,
			...
			Material.TORCH, Material.COMPASS, Material.CLOCK, Material.FLINT_AND_STEEL, Material.FIREWORK_ROCKET,
	...
	public MaterialList itemsRandomMaterials_BuildingChests = createList(tagRandomMaterials_BuildingChests,
			...
			Material.STRING, Material.TORCH, Material.COMPASS, Material.CLOCK, Material.SHEARS,

			Material.BOWL, Material.BUCKET, Material.GLASS_BOTTLE, Material.FLOWER_POT,

			Material.PAINTING, Material.ITEM_FRAME, Material.WHITE_BANNER,

			Material.FEATHER, Material.PAPER, Material.BOOK, Material.WRITABLE_BOOK, Material.MAP, Material.NAME_TAG,
	...
	public MaterialList itemsRandomMaterials_WarehouseChests = createList(tagRandomMaterials_WarehouseChests,
			...
			Material.RABBIT_FOOT, Material.RABBIT_HIDE, Material.LEATHER,
			...
			Material.STONE_HOE, Material.STONE_AXE, Material.STONE_PICKAXE, Material.STONE_SWORD,

			Material.LEAD, Material.CARROT_ON_A_STICK, Material.FISHING_ROD, Material.TOTEM_OF_UNDYING,
	...
	public MaterialList itemsRandomMaterials_FoodChests = createList(tagRandomMaterials_FoodChests,
			...
			Material.SUGAR, Material.CAKE, Material.COOKIE, Material.EGG, Material.APPLE, Material.MELON,
			Material.GLISTERING_MELON_SLICE, Material.CARROT, Material.BREAD,

			Material.BEEF, Material.CHICKEN, Material.COD, Material.MUTTON, Material.RABBIT, Material.POTATO,
			Material.POISONOUS_POTATO, Material.PUMPKIN, Material.BROWN_MUSHROOM, Material.RED_MUSHROOM,
			Material.BEETROOT,

			Material.COOKED_BEEF, Material.COOKED_CHICKEN, Material.COOKED_COD, Material.COOKED_MUTTON,
			Material.COOKED_RABBIT, Material.BAKED_POTATO, Material.PUMPKIN_PIE, Material.MUSHROOM_STEW,
	...
	public MaterialList itemsRandomMaterials_StorageShedChests = createList(tagRandomMaterials_StorageShedChests,
			...
			Material.TORCH, Material.PAPER, Material.BOOK,

			Material.COOKED_MUTTON, Material.BOWL, Material.MUSHROOM_STEW);
	...
	public MaterialList itemsRandomMaterials_FarmChests = createList(tagRandomMaterials_FarmChests,
			...
			Material.IRON_PICKAXE, Material.IRON_HOE,

			Material.LEATHER_BOOTS, Material.LEATHER_CHESTPLATE, Material.LEATHER_HELMET, Material.LEATHER_LEGGINGS,

			Material.BOW, Material.ARROW,

			Material.PAPER, Material.BOOK, Material.TORCH, Material.FISHING_ROD, Material.SHEARS, Material.BUCKET,
			Material.WATER_BUCKET, Material.MILK_BUCKET, Material.BONE, Material.BOWL,

			Material.COOKIE, Material.SUGAR, Material.COOKED_PORKCHOP, Material.COOKED_BEEF, Material.COOKED_CHICKEN,
			Material.COOKED_MUTTON, Material.COOKED_RABBIT, Material.BAKED_POTATO, Material.MELON, Material.PUMPKIN_PIE,
	...
	public MaterialList itemsRandomMaterials_FarmOutputChests = createList(tagRandomMaterials_FarmOutputChests,
			...
			Material.POTATO, Material.CARROT, Material.PUMPKIN_SEEDS, Material.MELON_SEEDS, Material.CARROT,
			Material.POTATO, Material.SUGAR_CANE, Material.APPLE);
	...
	public MaterialList itemsRandomMaterials_LumberChests = createList(tagRandomMaterials_LumberChests,
			...
			Material.FLINT_AND_STEEL, Material.COAL, Material.TORCH,

			Material.COOKED_PORKCHOP, Material.COOKED_CHICKEN, Material.COOKIE);
	...
	public MaterialList itemsRandomMaterials_LumberOutputChests = createList(tagRandomMaterials_LumberOutputChests,
			...
			Material.OAK_DOOR, Material.OAK_FENCE, Material.OAK_FENCE_GATE, Material.OAK_STAIRS,
			Material.OAK_PRESSURE_PLATE, Material.OAK_TRAPDOOR, Material.OAK_SLAB, Material.OAK_BOAT, Material.OAK_LOG,
			Material.OAK_PLANKS, Material.OAK_WOOD,

			Material.SPRUCE_DOOR, Material.SPRUCE_FENCE, Material.SPRUCE_FENCE_GATE, Material.SPRUCE_STAIRS,
			Material.SPRUCE_PRESSURE_PLATE, Material.SPRUCE_TRAPDOOR, Material.SPRUCE_SLAB, Material.SPRUCE_BOAT,
			Material.SPRUCE_LOG, Material.SPRUCE_PLANKS, Material.SPRUCE_WOOD,

			Material.BIRCH_DOOR, Material.BIRCH_FENCE, Material.BIRCH_FENCE_GATE, Material.BIRCH_STAIRS,
			Material.BIRCH_PRESSURE_PLATE, Material.BIRCH_TRAPDOOR, Material.BIRCH_SLAB, Material.BIRCH_BOAT,
			Material.BIRCH_LOG, Material.BIRCH_PLANKS, Material.BIRCH_WOOD,
			...
			Material.JUNGLE_LOG, Material.JUNGLE_PLANKS, Material.JUNGLE_WOOD,

			Material.ACACIA_DOOR, Material.ACACIA_FENCE, Material.ACACIA_FENCE_GATE, Material.ACACIA_STAIRS,
			Material.ACACIA_PRESSURE_PLATE, Material.ACACIA_TRAPDOOR, Material.ACACIA_SLAB, Material.ACACIA_BOAT,
			Material.ACACIA_LOG, Material.ACACIA_PLANKS, Material.ACACIA_WOOD,

			Material.DARK_OAK_DOOR, Material.DARK_OAK_FENCE, Material.DARK_OAK_FENCE_GATE, Material.DARK_OAK_STAIRS,
			Material.DARK_OAK_PRESSURE_PLATE, Material.DARK_OAK_TRAPDOOR, Material.DARK_OAK_SLAB,
			Material.DARK_OAK_BOAT, Material.DARK_OAK_LOG, Material.DARK_OAK_PLANKS, Material.DARK_OAK_WOOD,
	...
	public MaterialList itemsRandomMaterials_QuaryChests = createList(tagRandomMaterials_QuaryChests,
			...
			Material.FLINT_AND_STEEL, Material.TORCH, Material.BUCKET,
	...
	public MaterialList itemsSelectMaterial_BuildingWalls = createList(tagSelectMaterial_BuildingWalls,
			Material.COBBLESTONE, Material.SAND, Material.GRAVEL, Material.SANDSTONE, Material.BRICKS,
			Material.MOSSY_COBBLESTONE, Material.CLAY, Material.NETHERRACK, Material.SOUL_SAND, Material.STONE,
			Material.SMOOTH_STONE, Material.STONE_BRICKS, Material.NETHER_BRICKS, Material.QUARTZ_BLOCK,
			...
			Material.COAL_BLOCK, Material.RED_SANDSTONE, Material.RED_NETHER_BRICKS, Material.PRISMARINE,
			Material.PRISMARINE_BRICKS, Material.PURPUR_BLOCK, Material.PURPUR_PILLAR,
	...
	public MaterialList itemsSelectMaterial_UnfinishedBuildings = createList(tagSelectMaterial_UnfinishedBuildings,
			...
			Material.WHITE_CONCRETE, Material.GRAY_CONCRETE, Material.LIGHT_GRAY_CONCRETE, Material.BLACK_CONCRETE);
	...
	public MaterialList itemsSelectMaterial_GovernmentWalls = createList(tagSelectMaterial_GovernmentWalls,
			...
			Material.WHITE_TERRACOTTA, Material.LIGHT_GRAY_TERRACOTTA,

			Material.QUARTZ_BLOCK, Material.QUARTZ_PILLAR, Material.CHISELED_QUARTZ_BLOCK,

			Material.END_STONE, Material.END_STONE_BRICKS, Material.WHITE_WOOL);
	...
	public MaterialList itemsSelectMaterial_HouseWalls = createList(tagSelectMaterial_HouseWalls, Material.COBBLESTONE,
			...
			Material.PRISMARINE, Material.PURPUR_BLOCK,
	...
	public MaterialList itemsSelectMaterial_HouseFloors = createList(tagSelectMaterial_HouseFloors,
			...
			Material.BLACK_GLAZED_TERRACOTTA, Material.BLUE_GLAZED_TERRACOTTA, Material.BROWN_GLAZED_TERRACOTTA,
			Material.CYAN_GLAZED_TERRACOTTA, Material.GRAY_GLAZED_TERRACOTTA, Material.GREEN_GLAZED_TERRACOTTA,
			Material.LIGHT_BLUE_GLAZED_TERRACOTTA, Material.LIME_GLAZED_TERRACOTTA, Material.MAGENTA_GLAZED_TERRACOTTA,
			Material.ORANGE_GLAZED_TERRACOTTA, Material.PINK_GLAZED_TERRACOTTA, Material.PURPLE_GLAZED_TERRACOTTA,
			Material.RED_GLAZED_TERRACOTTA, Material.LIGHT_GRAY_GLAZED_TERRACOTTA, Material.WHITE_GLAZED_TERRACOTTA,
	...
	public MaterialList itemsSelectMaterial_QuaryPiles = createList(tagSelectMaterial_StoneWorksPiles, Material.GRAVEL, // easy
																														// but
																														// stupid
																														// way
																														// to
	...
	public MaterialList itemsSelectMaterial_BunkerBuildings = createList(tagSelectMaterial_BunkerBuildings,
			...
			Material.WHITE_TERRACOTTA, Material.WHITE_CONCRETE, Material.ORANGE_CONCRETE, Material.MAGENTA_CONCRETE,
	...
	public MaterialList itemsSelectMaterial_BunkerTanks = createList(tagSelectMaterial_BunkerTanks, Material.SPONGE,
			Material.REDSTONE_BLOCK, Material.END_STONE, Material.EMERALD_BLOCK,

			Material.LAVA, Material.ICE, Material.PACKED_ICE, Material.SNOW_BLOCK, Material.SLIME_BLOCK,
			Material.COAL_BLOCK, Material.SAND, Material.WATER,
	...
	public MaterialList itemsMaterialListFor_MazeWalls = createList(tagMaterialListFor_MazeWalls, Material.OBSIDIAN, // Walls
			Material.OBSIDIAN);// Underlayment

	public final static String tagMaterialListFor_Roads = "Materials_List_For_Roads";
	public MaterialList itemsMaterialListFor_Roads = createList(tagMaterialListFor_Roads, Material.WHITE_TERRACOTTA, // Pavement
	...
	public MaterialList itemsMaterialListFor_NormalOres = createList(tagMaterialListFor_NormalOres, Material.WATER, // liquid
																													// ore
			...
			Material.GOLD_ORE, Material.LAPIS_ORE, Material.REDSTONE_ORE, Material.DIAMOND_ORE, Material.EMERALD_ORE); // least
																														// frequent
																														// ore

	public final static String tagMaterialListFor_NetherOres = "Materials_List_For_NetherOres";
	public MaterialList itemsMaterialListFor_NetherOres = createList(tagMaterialListFor_NetherOres, Material.LAVA, // liquid
																													// ore
			Material.LAVA, // alt liquid ore
			...
			Material.GLOWSTONE, Material.NETHER_QUARTZ_ORE, Material.MAGMA_BLOCK, //
			Material.SOUL_SAND, Material.OBSIDIAN); // least frequent ore

	public final static String tagMaterialListFor_TheEndOres = "Materials_List_For_TheEndOres";
	public MaterialList itemsMaterialListFor_TheEndOres = createList(tagMaterialListFor_TheEndOres, Material.WATER, // liquid
																													// ore
			Material.LAVA, // alt liquid ore
			Material.GRAVEL, // gravel ore
			...
			Material.PURPUR_BLOCK, Material.GOLD_ORE, Material.LAPIS_ORE, Material.DIAMOND_ORE, Material.OBSIDIAN); // least
																													// frequent
																													// ore
