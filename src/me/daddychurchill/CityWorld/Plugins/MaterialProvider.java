...
public class MaterialProvider {
	...
	public MaterialList itemsSelectMaterial_BuildingWalls = createList(tagSelectMaterial_BuildingWalls,
			...
			Material.CHISELED_STONE_BRICKS, Material.CRACKED_STONE_BRICKS, Material.ACACIA_PLANKS,
			Material.BIRCH_PLANKS, Material.DARK_OAK_PLANKS, Material.JUNGLE_PLANKS, Material.OAK_PLANKS,
			Material.SPRUCE_PLANKS, Material.WHITE_WOOL, Material.ORANGE_WOOL, Material.MAGENTA_WOOL,
			Material.LIGHT_BLUE_WOOL, Material.YELLOW_WOOL, Material.LIME_WOOL, Material.PINK_WOOL, Material.GRAY_WOOL,
			Material.LIGHT_GRAY_WOOL, Material.CYAN_WOOL, Material.PURPLE_WOOL, Material.BLUE_WOOL, Material.BROWN_WOOL,
			Material.GREEN_WOOL, Material.RED_WOOL, Material.BLACK_WOOL, Material.TERRACOTTA, Material.WHITE_TERRACOTTA,
			...
			Material.BLACK_CONCRETE_POWDER, Material.WHITE_CONCRETE, Material.ORANGE_CONCRETE,
