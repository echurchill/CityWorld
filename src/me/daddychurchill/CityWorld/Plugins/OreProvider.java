...
public abstract class OreProvider extends Provider {
	...
	public abstract void sprinkleOres(CityWorldGenerator generator, PlatLot lot, SupportBlocks chunk, CachedYs blockYs, Odds odds, OreLocation location);
	public abstract String getCollectionName();

	protected void sprinkleOre(CityWorldGenerator generator, PlatLot lot, SupportBlocks chunk, CachedYs blockYs,
	...
	protected boolean placeBlock(SupportBlocks chunk, Odds odds, int x, int y, int z, Material material) {
