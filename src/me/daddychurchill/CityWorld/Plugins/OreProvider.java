...
public abstract class OreProvider extends Provider {
	...
	public abstract void sprinkleOres(CityWorldGenerator generator, PlatLot lot, SupportSection chunk, CachedYs blockYs, Odds odds, OreLocation location);
	public abstract String getCollectionName();

	protected void sprinkleOre(CityWorldGenerator generator, PlatLot lot, SupportSection chunk, CachedYs blockYs,
	...
	private void growVein(CityWorldGenerator generator, PlatLot lot, SupportSection chunk, CachedYs blockYs, 
	...
	private int placeOre(CityWorldGenerator generator, SupportSection chunk, Odds odds, 
	...
	protected boolean placeBlock(SupportSection chunk, Odds odds, int x, int y, int z, Material material) {
