...
public class MazeNatureLot extends NatureLot {
	...
	protected Material getWallMaterial(CityWorldGenerator generator) {
		return generator.settings.materials.itemsMaterialsForMazeWalls.getNthMaterial(0, Material.OBSIDIAN);
	}
	
	protected Material getLaymentMaterial(CityWorldGenerator generator) {
		return generator.settings.materials.itemsMaterialsForMazeWalls.getNthMaterial(1, Material.OBSIDIAN);
	}
