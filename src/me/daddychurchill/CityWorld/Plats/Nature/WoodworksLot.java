...
public class WoodworksLot extends ConstructLot {
	...
	private void generateSomething(CityWorldGenerator generator, RealChunk chunk, int x, int y, int z) {
	...
	protected void generateSection(RealChunk chunk, int x, int y, int z) {
	...
	private void generateColumn(RealChunk chunk, int x, int y, int z) {
	...
	protected void generateStairs(RealChunk chunk, int x, int y, int z) {
